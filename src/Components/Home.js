        ...
        <div className="home-nav-content">
          ...
          <div className="home-nav-right-section">
            ...
            <div className="home-language-buttons">
              ...
              <button 
                className={`home-lang-btn ${language === 'hi' ? 'active' : ''}`}
                onClick={() => setLanguage('hi')}
              >
                हिं
              </button>
              <button 
                className={`home-lang-btn ${language === 'mr' ? 'active' : ''}`}
                onClick={() => setLanguage('mr')}
              >
                मर
              </button>
              <button 
                className={`home-lang-btn ${language === 'te' ? 'active' : ''}`}
            ...
            <div className="home-profile-container" ref={dropdownRef}>
              ...
              {isProfileOpen && (
                <div className="home-profile-dropdown">
                  ...
                  <Link to="/login" className="home-dropdown-item home-signup-special">
                     {t.navLinks.login}
                  </Link>
                  <Link to="/signup" className="home-dropdown-item home-signup-special">
                     {t.navLinks.signup}
                  </Link>
                </div>
              )}
      ...
      <div className="home-animation-section" ref={animationRef}>
        <div className="home-sticky-container">
          ...
          <div className="home-content-wrapper">
            <div
              className="home-stage-title-container"
              style={{
            ...
            <div
              ...
              style={{
                ...
                transform: `scale(${paragraphScale})`,
              }}
            >
            ...
            <div
              className="home-frequency-container"
              style={{
                opacity: frequencyOpacity * frequencyFade,
                transform: `scale(${frequencyScale})`,
              }}
            >
            ...
            <div
              className="home-final-text-container"
              style={{
                opacity: finalTextProgress,
              }}
            >
