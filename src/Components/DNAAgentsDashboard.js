...
const API_BASE = 'http://localhost:5000/api/dna';
            ...
            <div className="dna-agents-main-card">
              ...
              <form className="dna-agent-form-grid" onSubmit={handleRun}>
                ...
                <div className="dna-agent-actions full-width">
                  <button type="submit" className="dna-agents-primary-btn">Run agent</button>
                  <button type="button" className="dna-agents-outline-btn" onClick={() => setFormData(defaultValuesFor(selectedAgent, patient))}>Reset inputs</button>
                </div>
              </form>
            </div>
            ...
            <div className="dna-dashboard-grid">
              ...
              <div className="dna-emergency-card">
                ...
                <div className="dna-map-box">
                  <div className="dna-map-marker" />
                  <div>
                    <strong>Map support</strong>
                    <p>Open exact location guidance in a separate map tab.</p>
                  </div>
                  <a className="dna-action-btn" href={emergencyData.mapUrl} target="_blank" rel="noreferrer">Open map</a>
                </div>
